    ...
    <form class="form-horizontal" method="post" action="/staff/edit/{{ $staff->id }}">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-2">
                <button type="submit" class="form-control btn btn-primary">@lang('staff.btnSave')</button>
            </div>
            <div class="col-md-offset-2 col-md-2">
                <button type="reset" class="form-control btn btn-primary">@lang('staff.btnCancel')</button>
            </div>
        </div>
    </form>
